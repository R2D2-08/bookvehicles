...
export default function ClientLayout({ children }) {
  ...
  return (
    <UserProvider>
      {/* Only show Navbar if not on driver dashboard */}
      {!pathname.startsWith('/driverdash') && <Navbar />}
      ...
      {/* Only show Footer if not on driver dashboard */}
      {!pathname.startsWith('/driverdash') && <Footer />}
    </UserProvider>
  );
} 